...
function newspack_enqueue_scripts() {
	...
	wp_register_script( 'newspack-hide-fse-blocks', get_theme_file_uri( '/js/dist/editor-remove-blocks.js' ), array(
			'wp-blocks',
			'wp-dom-ready',
			'wp-edit-post'
	), $theme_version, true );
...
function newspack_colors_css_variables() {
	...
	<style type="text/css" id="newspack-theme-colors-variables">
		:root {
		<?php foreach ( $colors as $color_key => $color_value ) : ?> --newspack- <?php echo esc_attr( str_replace( '_', '-', $color_key ) ); ?> -color: <?php echo esc_attr( $color_value ); ?>;
		<?php endforeach; ?>
		}
	</style>
	<?php
