...
<?php if ( $this->error ): ?>
	<div class="wrap">
		<h2><?php echo esc_html( 'Kaltura Video Network Installation' ); ?></h2>
		<br />
...
<?php
	...
	<div class="wrap">
		...
		<p>
			This installation page should be used in order to configure the default Kaltura integration settings for Network Installation.
		</p>
		...
		<form name="form1" method="post">
			<table class="form-table">
				<tr valign="top">
					...
					<td><input type="text" id="server_url" name="server_url" value="<?php echo !empty( get_site_option('kaltura_server_url') ) ? get_site_option('kaltura_server_url') : ''; ?>" size="70" /></td>
				</tr>	
				<tr valign="top">
